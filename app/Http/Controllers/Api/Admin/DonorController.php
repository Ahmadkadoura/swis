...
//    public function show(User $donor): JsonResponse
//    {
//        return $this->showOne($donor,UserResource::class);
//    }
...
//    public function update(UpdateDonorRequest $request, User $donor): JsonResponse
//    {
//        $newData=$request->validated();
//
